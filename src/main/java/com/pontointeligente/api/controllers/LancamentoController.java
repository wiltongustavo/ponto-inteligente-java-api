...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
	    ...
	    Sort.Direction direcao = Sort.Direction.fromString(dir); // Use fromString para obter a direção correta
	    Pageable pageRequest = PageRequest.of(pag, this.qtdPorPagina, direcao, ord);
